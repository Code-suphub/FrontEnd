...
public class WebResourceController {
  ...
  public ForumResource getResourceById(@PathVariable("id") Integer id) {
  ...
  public List<ForumResource> getAllResourcebyAuthor(@PathVariable("author") String author) {
    QueryWrapper<ForumResource> wrapper = new QueryWrapper<>();
  ...
  public List<ForumResource> FindresourceByNum(
  ...
  public Map<String, Object> getPrenewsResource(@PathVariable("id") String id) {
    ...
    wrapper
        ...
        .orderByAsc("id")
        .last("limit 1");
    ForumResource resource = resourceMapper.selectOne(wrapper);
    if (resource == null) {
